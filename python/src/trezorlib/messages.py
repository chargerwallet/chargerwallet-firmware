...
class ChargerwalletFeatures(protobuf.MessageType):
    ...
    FIELDS = {
        1: protobuf.Field("chargerwallet_device_type", "ChargerWalletDeviceType", repeated=False, required=False),
        2: protobuf.Field("chargerwallet_board_version", "string", repeated=False, required=False),
        3: protobuf.Field("chargerwallet_boot_version", "string", repeated=False, required=False),
        4: protobuf.Field("chargerwallet_firmware_version", "string", repeated=False, required=False),
        5: protobuf.Field("chargerwallet_board_hash", "bytes", repeated=False, required=False),
        6: protobuf.Field("chargerwallet_boot_hash", "bytes", repeated=False, required=False),
        7: protobuf.Field("chargerwallet_firmware_hash", "bytes", repeated=False, required=False),
        8: protobuf.Field("chargerwallet_board_build_id", "string", repeated=False, required=False),
        9: protobuf.Field("chargerwallet_boot_build_id", "string", repeated=False, required=False),
        10: protobuf.Field("chargerwallet_firmware_build_id", "string", repeated=False, required=False),
        11: protobuf.Field("chargerwallet_serial_no", "string", repeated=False, required=False),
        12: protobuf.Field("chargerwallet_ble_name", "string", repeated=False, required=False),
        13: protobuf.Field("chargerwallet_ble_version", "string", repeated=False, required=False),
        14: protobuf.Field("chargerwallet_ble_build_id", "string", repeated=False, required=False),
        15: protobuf.Field("chargerwallet_ble_hash", "bytes", repeated=False, required=False),
        16: protobuf.Field("chargerwallet_se_type", "ChargerWalletSeType", repeated=False, required=False),
    }
    ...
    def __init__(
        ...
        *,
        ...
        chargerwallet_boot_hash: Optional["bytes"] = None,
        chargerwallet_firmware_hash: Optional["bytes"] = None,
        chargerwallet_board_build_id: Optional["str"] = None,
        chargerwallet_boot_build_id: Optional["str"] = None,
        chargerwallet_firmware_build_id: Optional["str"] = None,
        chargerwallet_serial_no: Optional["str"] = None,
        chargerwallet_ble_name: Optional["str"] = None,
        ...
        self.chargerwallet_boot_hash = chargerwallet_boot_hash
        self.chargerwallet_firmware_hash = chargerwallet_firmware_hash
        self.chargerwallet_board_build_id = chargerwallet_board_build_id
        self.chargerwallet_boot_build_id = chargerwallet_boot_build_id
        self.chargerwallet_firmware_build_id = chargerwallet_firmware_build_id
        self.chargerwallet_serial_no = chargerwallet_serial_no
        self.chargerwallet_ble_name = chargerwallet_ble_name
