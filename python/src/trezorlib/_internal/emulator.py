...
class Emulator:
    ...
    def __init__(
        ...
        *,
        ...
        if logfile:
            ...
            self.logfile = self.profile_dir / "chargerwallet.log"
    ...
    def start(self) -> None:
        ...
        (self.profile_dir / "chargerwallet.pid").write_text(str(self.process.pid) + "\n")
        (self.profile_dir / "chargerwallet.port").write_text(str(self.port) + "\n")
    ...
    def stop(self) -> None:
        ...
        _rm_f(self.profile_dir / "chargerwallet.pid")
        _rm_f(self.profile_dir / "chargerwallet.port")
        self.process = None
...
class CoreEmulator(Emulator):
    STORAGE_FILENAME = "chargerwallet.flash"
    ...
    def __init__(
        ...
        **kwargs: Any,
        ...
        self.sdcard = self.profile_dir / "chargerwallet.sdcard"
