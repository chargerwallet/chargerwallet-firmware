...
@cli.command()
@with_client
def get_chargerwallet_features(client: "TrezorClient") -> messages.Features:
    """Retrieve device features and settings."""
    return client.refresh_chargerwallet_features()
...
cli.add_command(ethereum_chargerwallet.cli)
