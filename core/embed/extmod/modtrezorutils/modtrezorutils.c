...
/// def chargerwallet_firmware_hash() -> bytes:
///     """
///     Computes the sha256 hash of the firmware
///     """
STATIC mp_obj_t mod_trezorutils_chargerwallet_firmware_hash(void) {
  vstr_t hash = {0};
...
STATIC MP_DEFINE_CONST_FUN_OBJ_0(mod_trezorutils_chargerwallet_firmware_hash_obj,
                                 mod_trezorutils_chargerwallet_firmware_hash);
...
MP_DEFINE_STR_OBJ(mp_CHARGERWALLET_VERSION, CHARGERWALLET_VERSION);
...
STATIC const mp_rom_map_elem_t mp_module_trezorutils_globals_table[] = {
    ...
    {MP_ROM_QSTR(MP_QSTR_chargerwallet_firmware_hash),
     MP_ROM_PTR(&mod_trezorutils_chargerwallet_firmware_hash_obj)},
    ...
    {MP_ROM_QSTR(MP_QSTR_CHARGERWALLET_VERSION), MP_ROM_PTR(&mp_CHARGERWALLET_VERSION)},
