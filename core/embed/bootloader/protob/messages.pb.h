...
typedef enum _MessageType { 
    ...
    MessageType_MessageType_ChargerwalletGetFeatures = 10025, 
    MessageType_MessageType_ChargerwalletFeatures = 10026, 
...
typedef enum _ChargerWalletDeviceType { 
    ChargerWalletDeviceType_CLASSIC = 0, 
    ChargerWalletDeviceType_CLASSIC1S = 1, 
    ChargerWalletDeviceType_MINI = 2, 
    ChargerWalletDeviceType_TOUCH = 3, 
    ChargerWalletDeviceType_PRO = 5 
} ChargerWalletDeviceType;

typedef enum _ChargerWalletSeType { 
    ChargerWalletSeType_THD89 = 0, 
    ChargerWalletSeType_SE608A = 1 
} ChargerWalletSeType;
...
typedef struct _ChargerwalletGetFeatures { 
    char dummy_field;
...
typedef PB_BYTES_ARRAY_T(32) Features_chargerwallet_board_hash_t;
typedef PB_BYTES_ARRAY_T(32) Features_chargerwallet_boot_hash_t;
typedef PB_BYTES_ARRAY_T(32) Features_chargerwallet_firmware_hash_t;
typedef struct _Features { 
    ...
    bool backup_only; 
    bool has_chargerwallet_version;
    char chargerwallet_version[32]; 
    ...
    bool has_chargerwallet_device_type;
    ChargerWalletDeviceType chargerwallet_device_type; 
    bool has_chargerwallet_se_type;
    ChargerWalletSeType chargerwallet_se_type; 
    bool has_chargerwallet_board_version;
    char chargerwallet_board_version[32]; 
    bool has_chargerwallet_board_hash;
    Features_chargerwallet_board_hash_t chargerwallet_board_hash; 
    bool has_chargerwallet_boot_version;
    char chargerwallet_boot_version[16]; 
    bool has_chargerwallet_boot_hash;
    Features_chargerwallet_boot_hash_t chargerwallet_boot_hash; 
    bool has_chargerwallet_firmware_version;
    char chargerwallet_firmware_version[16]; 
    bool has_chargerwallet_firmware_hash;
    Features_chargerwallet_firmware_hash_t chargerwallet_firmware_hash; 
    bool has_chargerwallet_firmware_build_id;
    char chargerwallet_firmware_build_id[64]; 
    bool has_chargerwallet_serial_no;
    char chargerwallet_serial_no[32]; 
    bool has_chargerwallet_boot_build_id;
    char chargerwallet_boot_build_id[8]; 
    bool has_chargerwallet_ble_name;
    char chargerwallet_ble_name[32]; 
    bool has_chargerwallet_ble_version;
    char chargerwallet_ble_version[16]; 
} Features;
...
typedef PB_BYTES_ARRAY_T(32) ChargerwalletFeatures_chargerwallet_board_hash_t;
typedef PB_BYTES_ARRAY_T(32) ChargerwalletFeatures_chargerwallet_boot_hash_t;
typedef PB_BYTES_ARRAY_T(32) ChargerwalletFeatures_chargerwallet_firmware_hash_t;
typedef PB_BYTES_ARRAY_T(32) ChargerwalletFeatures_chargerwallet_ble_hash_t;
typedef struct _ChargerwalletFeatures { 
    bool has_chargerwallet_device_type;
    ChargerWalletDeviceType chargerwallet_device_type; 
    bool has_chargerwallet_board_version;
    char chargerwallet_board_version[32]; 
    ...
    char chargerwallet_firmware_version[16]; 
    bool has_chargerwallet_board_hash;
    ChargerwalletFeatures_chargerwallet_board_hash_t chargerwallet_board_hash; 
    bool has_chargerwallet_boot_hash;
    ChargerwalletFeatures_chargerwallet_boot_hash_t chargerwallet_boot_hash; 
    bool has_chargerwallet_firmware_hash;
    ChargerwalletFeatures_chargerwallet_firmware_hash_t chargerwallet_firmware_hash; 
    bool has_chargerwallet_board_build_id;
    char chargerwallet_board_build_id[8]; 
    bool has_chargerwallet_boot_build_id;
    char chargerwallet_boot_build_id[8]; 
    bool has_chargerwallet_firmware_build_id;
    char chargerwallet_firmware_build_id[64]; 
    ...
    bool has_chargerwallet_ble_version;
    char chargerwallet_ble_version[16]; 
    bool has_chargerwallet_ble_build_id;
    char chargerwallet_ble_build_id[8]; 
    bool has_chargerwallet_ble_hash;
    ChargerwalletFeatures_chargerwallet_ble_hash_t chargerwallet_ble_hash; 
    bool has_chargerwallet_se_type;
    ChargerWalletSeType chargerwallet_se_type; 
...
#define _ChargerWalletDeviceType_MIN ChargerWalletDeviceType_CLASSIC
#define _ChargerWalletDeviceType_MAX ChargerWalletDeviceType_PRO
#define _ChargerWalletDeviceType_ARRAYSIZE ((ChargerWalletDeviceType)(ChargerWalletDeviceType_PRO+1))

#define _ChargerWalletSeType_MIN ChargerWalletSeType_THD89
#define _ChargerWalletSeType_MAX ChargerWalletSeType_SE608A
#define _ChargerWalletSeType_ARRAYSIZE ((ChargerWalletSeType)(ChargerWalletSeType_SE608A+1))
...
#define ChargerwalletGetFeatures_init_default           {0}
#define Features_init_default                    {false, "", 0, 0, 0, false, 0, false, "", false, "", false, "", false, 0, false, {0, {0}}, false, 0, false, "", false, 0, false, 0, false, 0, false, "", false, 0, false, "", false, "", false, 0, false, 0, false, "", false, 0, false, "", false, "", false, "", false, 0, false, "", false, _ChargerWalletDeviceType_MIN, false, _ChargerWalletSeType_MIN, false, "", false, {0, {0}}, false, "", false, {0, {0}}, false, "", false, {0, {0}}, false, "", false, "", false, "", false, "", false, ""}
#define ChargerwalletFeatures_init_default              {false, _ChargerWalletDeviceType_MIN, false, "", false, "", false, "", false, {0, {0}}, false, {0, {0}}, false, {0, {0}}, false, "", false, "", false, "", false, "", false, "", false, "", false, "", false, {0, {0}}, false, _ChargerWalletSeType_MIN}
...
#define ChargerwalletGetFeatures_init_zero              {0}
#define Features_init_zero                       {false, "", 0, 0, 0, false, 0, false, "", false, "", false, "", false, 0, false, {0, {0}}, false, 0, false, "", false, 0, false, 0, false, 0, false, "", false, 0, false, "", false, "", false, 0, false, 0, false, "", false, 0, false, "", false, "", false, "", false, 0, false, "", false, _ChargerWalletDeviceType_MIN, false, _ChargerWalletSeType_MIN, false, "", false, {0, {0}}, false, "", false, {0, {0}}, false, "", false, {0, {0}}, false, "", false, "", false, "", false, "", false, ""}
#define ChargerwalletFeatures_init_zero                 {false, _ChargerWalletDeviceType_MIN, false, "", false, "", false, "", false, {0, {0}}, false, {0, {0}}, false, {0, {0}}, false, "", false, "", false, "", false, "", false, "", false, "", false, "", false, {0, {0}}, false, _ChargerWalletSeType_MIN}
...
#define Features_chargerwallet_version_tag              508
...
#define Features_chargerwallet_device_type_tag          600
#define Features_chargerwallet_se_type_tag              601
#define Features_chargerwallet_board_version_tag        602
#define Features_chargerwallet_board_hash_tag           603
#define Features_chargerwallet_boot_version_tag         604
#define Features_chargerwallet_boot_hash_tag            605
#define Features_chargerwallet_firmware_version_tag     609
#define Features_chargerwallet_firmware_hash_tag        610
#define Features_chargerwallet_firmware_build_id_tag    611
#define Features_chargerwallet_serial_no_tag            612
#define Features_chargerwallet_boot_build_id_tag        613
#define Features_chargerwallet_ble_name_tag             614
#define Features_chargerwallet_ble_version_tag          615
...
#define ChargerwalletFeatures_chargerwallet_device_type_tag    1
#define ChargerwalletFeatures_chargerwallet_board_version_tag  2
#define ChargerwalletFeatures_chargerwallet_boot_version_tag   3
#define ChargerwalletFeatures_chargerwallet_firmware_version_tag 4
#define ChargerwalletFeatures_chargerwallet_board_hash_tag     5
#define ChargerwalletFeatures_chargerwallet_boot_hash_tag      6
#define ChargerwalletFeatures_chargerwallet_firmware_hash_tag  7
#define ChargerwalletFeatures_chargerwallet_board_build_id_tag 8
#define ChargerwalletFeatures_chargerwallet_boot_build_id_tag  9
#define ChargerwalletFeatures_chargerwallet_firmware_build_id_tag 10
#define ChargerwalletFeatures_chargerwallet_serial_no_tag      11
#define ChargerwalletFeatures_chargerwallet_ble_name_tag       12
#define ChargerwalletFeatures_chargerwallet_ble_version_tag    13
#define ChargerwalletFeatures_chargerwallet_ble_build_id_tag   14
#define ChargerwalletFeatures_chargerwallet_ble_hash_tag       15
#define ChargerwalletFeatures_chargerwallet_se_type_tag        16
...
#define ChargerwalletGetFeatures_FIELDLIST(X, a) \

#define ChargerwalletGetFeatures_CALLBACK NULL
#define ChargerwalletGetFeatures_DEFAULT NULL
...
X(a, STATIC,   OPTIONAL, STRING,   chargerwallet_version,  508) \
...
X(a, STATIC,   OPTIONAL, UENUM,    chargerwallet_device_type, 600) \
X(a, STATIC,   OPTIONAL, UENUM,    chargerwallet_se_type,  601) \
X(a, STATIC,   OPTIONAL, STRING,   chargerwallet_board_version, 602) \
X(a, STATIC,   OPTIONAL, BYTES,    chargerwallet_board_hash, 603) \
X(a, STATIC,   OPTIONAL, STRING,   chargerwallet_boot_version, 604) \
X(a, STATIC,   OPTIONAL, BYTES,    chargerwallet_boot_hash, 605) \
X(a, STATIC,   OPTIONAL, STRING,   chargerwallet_firmware_version, 609) \
X(a, STATIC,   OPTIONAL, BYTES,    chargerwallet_firmware_hash, 610) \
X(a, STATIC,   OPTIONAL, STRING,   chargerwallet_firmware_build_id, 611) \
X(a, STATIC,   OPTIONAL, STRING,   chargerwallet_serial_no, 612) \
X(a, STATIC,   OPTIONAL, STRING,   chargerwallet_boot_build_id, 613) \
X(a, STATIC,   OPTIONAL, STRING,   chargerwallet_ble_name, 614) \
X(a, STATIC,   OPTIONAL, STRING,   chargerwallet_ble_version, 615)
#define Features_CALLBACK NULL
#define Features_DEFAULT NULL

#define ChargerwalletFeatures_FIELDLIST(X, a) \
X(a, STATIC,   OPTIONAL, UENUM,    chargerwallet_device_type,   1) \
X(a, STATIC,   OPTIONAL, STRING,   chargerwallet_board_version,   2) \
X(a, STATIC,   OPTIONAL, STRING,   chargerwallet_boot_version,   3) \
X(a, STATIC,   OPTIONAL, STRING,   chargerwallet_firmware_version,   4) \
X(a, STATIC,   OPTIONAL, BYTES,    chargerwallet_board_hash,   5) \
X(a, STATIC,   OPTIONAL, BYTES,    chargerwallet_boot_hash,   6) \
X(a, STATIC,   OPTIONAL, BYTES,    chargerwallet_firmware_hash,   7) \
X(a, STATIC,   OPTIONAL, STRING,   chargerwallet_board_build_id,   8) \
X(a, STATIC,   OPTIONAL, STRING,   chargerwallet_boot_build_id,   9) \
X(a, STATIC,   OPTIONAL, STRING,   chargerwallet_firmware_build_id,  10) \
X(a, STATIC,   OPTIONAL, STRING,   chargerwallet_serial_no,  11) \
X(a, STATIC,   OPTIONAL, STRING,   chargerwallet_ble_name,  12) \
X(a, STATIC,   OPTIONAL, STRING,   chargerwallet_ble_version,  13) \
X(a, STATIC,   OPTIONAL, STRING,   chargerwallet_ble_build_id,  14) \
X(a, STATIC,   OPTIONAL, BYTES,    chargerwallet_ble_hash,  15) \
X(a, STATIC,   OPTIONAL, UENUM,    chargerwallet_se_type,   16)
#define ChargerwalletFeatures_CALLBACK NULL
#define ChargerwalletFeatures_DEFAULT NULL
...
extern const pb_msgdesc_t ChargerwalletGetFeatures_msg;
extern const pb_msgdesc_t Features_msg;
extern const pb_msgdesc_t ChargerwalletFeatures_msg;
...
#define ChargerwalletGetFeatures_fields &ChargerwalletGetFeatures_msg
#define Features_fields &Features_msg
#define ChargerwalletFeatures_fields &ChargerwalletFeatures_msg
...
#define ChargerwalletFeatures_size                      383
#define ChargerwalletGetFeatures_size                   0
