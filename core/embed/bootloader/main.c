...
static void usb_init_all(secbool usb21_landing) {
  usb_dev_info_t dev_info = {
      ...
      .product_id = 0x4F4A,
      .release_num = 0x0200,
      .manufacturer = "ChargerWallet",
      .product = "CHARGERWALLET Touch Boot",
      .serial_number = "000000000000000000000000",
      .interface = "CHARGERWALLET Interface",
  ...
  for (;;) {
    ...
    switch (msg_id) {
      ...
      case MSG_NAME_TO_ID(EmmcDirRemove):  // EmmcDirRemove
        ...
        break;
      case MSG_NAME_TO_ID(ChargerwalletGetFeatures):  // ChargerwalletGetFeatures
        process_msg_ChargerwalletGetFeatures(USB_IFACE_NUM, msg_size, buf, vhdr, hdr);
        break;
      default:
