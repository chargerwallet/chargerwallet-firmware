...
def change_key_bg(
    ...
    if enabled:
        if dsc.id == id1:
            dsc.rect_dsc.bg_color = lv_colors.CHARGERWALLET_RED_1
        elif dsc.id == id2:
            if all_enabled:
                dsc.rect_dsc.bg_color = lv_colors.CHARGERWALLET_GREEN
                dsc.label_dsc.color = lv_colors.BLACK
            else:
                dsc.rect_dsc.bg_color = lv_colors.CHARGERWALLET_BLACK_1
                dsc.label_dsc.color = lv_colors.CHARGERWALLET_GRAY_1
    else:
        if dsc.id in (id1, id2):
            dsc.rect_dsc.bg_color = lv_colors.CHARGERWALLET_BLACK_1
            if dsc.id == id2:
                dsc.label_dsc.color = (
                    lv_colors.CHARGERWALLET_GRAY_1 if not allow_empty else lv_colors.BLACK
                )
...
class BIP39Keyboard(lv.keyboard):
    ...
    def __init__(self, parent):
        ...
        self.add_style(
            StyleWrapper().bg_color(lv_colors.CHARGERWALLET_GRAY_3),
            lv.PART.ITEMS | lv.STATE.PRESSED,
        )
        self.add_style(
            StyleWrapper()
            .bg_grad_color(lv_colors.CHARGERWALLET_BLACK_1)
    ...
    def tip_submitted(self):
        ...
        self.tip_panel.add_style(
            ...
            .text_color(lv_colors.CHARGERWALLET_GREEN)
            .text_align_left(),
            0,
        )
    ...
    def event_cb(self, event):
        if event.code == lv.EVENT.DRAW_PART_BEGIN:
            ...
            if len(txt_input) > 0:
                ...
                btn_style_pressed = (
                    StyleWrapper()
                    .bg_color(lv_colors.CHARGERWALLET_GRAY_3)
                    .bg_opa()
...
class NumberKeyboard(lv.keyboard):
    ...
    def __init__(self, parent) -> None:
        ...
        self.add_style(
            StyleWrapper()
            .bg_color(lv_colors.CHARGERWALLET_BLACK_1)
            .text_color(lv_colors.CHARGERWALLET_GRAY),
            lv.PART.ITEMS | lv.STATE.DISABLED,
        )
...
class PassphraseKeyboard(lv.btnmatrix):
    def __init__(self, parent, max_len) -> None:
        ...
        self.ta.add_style(
            StyleWrapper()
            .bg_color(lv_colors.CHARGERWALLET_BLACK_3)
            .bg_opa()
            .border_width(1)
            .border_color(lv_colors.CHARGERWALLET_GRAY_2)
            .text_font(font_PJSBOLD36)
            .text_color(lv_colors.WHITE)
            .text_align_left()
            .radius(0)
