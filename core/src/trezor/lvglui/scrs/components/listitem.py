...
class ListItemWithLeadingCheckbox(lv.obj):
    def __init__(self, parent, text):
        ...
        self.checkbox.add_style(
            ...
            .pad_all(0)
            .bg_color(lv_colors.CHARGERWALLET_BLACK_4)
            .border_color(lv_colors.CHARGERWALLET_GRAY)
            .border_width(2)
        ...
        self.checkbox.add_style(
            StyleWrapper()
            .bg_color(lv_colors.CHARGERWALLET_GREEN)
...
class DisplayItem(lv.obj):
    def __init__(self, parent, title, content, bg_color=lv_colors.CHARGERWALLET_GRAY_3):
        super().__init__(parent)
        self.set_size(464, lv.SIZE.CONTENT)
        self.add_style(
            StyleWrapper()
