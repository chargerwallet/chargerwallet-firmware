    ...
    def __init__(
        ...
        if has_details:
            ...
            self.view_btn.add_style(
                StyleWrapper()
                .border_width(2)
                .border_color(lv_colors.CHARGERWALLET_GRAY_1)
...
class BlobDisPlay(FullSizeWindow):
    def __init__(
        ...
        super().__init__(
            ...
            icon_path=icon_path,
            anim_dir=anim_dir,
            primary_color=primary_color or lv_colors.CHARGERWALLET_GREEN,
        )
        self.primary_color = primary_color
        self.container = ContainerFlexCol(self.content_area, self.title, pos=(0, 40))
...
class NftRemoveConfirm(FullSizeWindow):
    def __init__(self, icon_path):
        ...
        self.btn_yes.enable(bg_color=lv_colors.CHARGERWALLET_RED_1, text_color=lv_colors.BLACK)
