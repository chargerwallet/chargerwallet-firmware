...
class Bip39DotMap(FullSizeWindow):
    ...
    def show_back(self):
        ...
        self.btn_yes.enable(lv_colors.CHARGERWALLET_GREEN, text_color=lv_colors.BLACK)
    ...
    class BinaryWordIndex(lv.obj):
        def __init__(self, parent) -> None:
            ...
            self.point_style = (
                ...
                .width(16)
                .height(16)
                .bg_color(lv_colors.CHARGERWALLET_WHITE_4)
                .border_width(0)
        ...
        class Point(lv.obj):
            ...
            def set_checked(self):
                self.checked = True
                self.set_style_bg_color(lv_colors.CHARGERWALLET_GREEN_2, 0)

            def set_uncheck(self):
                self.checked = False
                self.set_style_bg_color(lv_colors.CHARGERWALLET_WHITE_4, 0)
...
class Line(lv.line):
    def __init__(self, parent, line_width) -> None:
        ...
        style_line.init()
        style_line.set_line_color(lv_colors.CHARGERWALLET_GRAY_2)
