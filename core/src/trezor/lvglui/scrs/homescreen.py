    ...
    class AppDrawer(lv.obj):
        def __init__(self, parent) -> None:
            ...
            self.tips.add_style(
                ...
                .text_font(font_PJSREG24)
                .max_width(464)
                .text_color(lv_colors.CHARGERWALLET_GRAY_4)
                .text_align_center(),
                0,
            )
...
class NftManager(Screen):
    def __init__(self, prev_scr, nft_config, file_name):
        ...
        self.btn_yes.enable(lv_colors.CHARGERWALLET_PURPLE, lv_colors.BLACK)
        ...
        self.panel.add_style(
            StyleWrapper()
            .bg_color(lv_colors.CHARGERWALLET_BLACK)
            .text_color(lv_colors.CHARGERWALLET_RED_1)
...
class SettingsScreen(Screen):
    def __init__(self, prev_scr=None):
        if not hasattr(self, "_init"):
            ...
            return
        # if __debug__:
        #     self.add_style(StyleWrapper().bg_color(lv_colors.CHARGERWALLET_GREEN_1), 0)
        ...
        self.power.label_left.set_style_text_color(lv_colors.CHARGERWALLET_RED_1, 0)
        # if __debug__:
...
class TapAwakeSetting(Screen):
    def __init__(self, prev_scr=None):
        ...
        self.description.set_style_text_color(lv_colors.CHARGERWALLET_GRAY, lv.STATE.DEFAULT)
...
class TrezorModeToggle(FullSizeWindow):
    def __init__(self, callback_obj, enable=False):
        ...
        if not enable:
            self.btn_yes.enable(
                bg_color=lv_colors.CHARGERWALLET_YELLOW, text_color=lv_colors.BLACK
            )
            self.tips_bar = Banner(
...
class Go2UpdateMode(Screen):
    def __init__(self, prev_scr):
        ...
        self.btn_yes.enable(lv_colors.CHARGERWALLET_GREEN, lv_colors.BLACK)
...
class PowerOff(FullSizeWindow):
    ...
    def __init__(self, re_loop: bool = False):
        ...
        self.btn_yes.enable(lv_colors.CHARGERWALLET_RED_1, text_color=lv_colors.BLACK)
...
class WallPaperManage(Screen):
    def __init__(
        ...
        self.btn_yes.add_style(
            StyleWrapper().bg_color(lv_colors.CHARGERWALLET_GREEN).text_color(lv_colors.BLACK),
            0,
        )
        if not is_internal:
            self.btn_yes.set_size(231, 98)
            ...
            #     StyleWrapper()
            #     .bg_color(lv_colors.CHARGERWALLET_RED)
            #     .text_color(lv_colors.CHARGERWALLET_RED_1),
            #     0,
            # )
            self.panel = lv.obj(self.btn_del)
...
class SecurityScreen(Screen):
    def __init__(self, prev_scr=None):
        ...
        self.rest_device.label_left.set_style_text_color(lv_colors.CHARGERWALLET_RED_1, 0)
        self.container.add_event_cb(self.on_click, lv.EVENT.CLICKED, None)
    ...
    def retrieval_state(self):
        if safety_checks.is_strict():
            ...
            self.description.set_style_text_color(
                lv_colors.CHARGERWALLET_GRAY, lv.STATE.DEFAULT
            )
            ...
            if target == self.passphrase.switch:
                if target.has_state(lv.STATE.CHECKED):
                    screen = PassphraseTipsConfirm(
                        ...
                        self,
                        primary_color=lv_colors.CHARGERWALLET_YELLOW,
                    )
                    screen.btn_yes.enable(lv_colors.CHARGERWALLET_YELLOW, lv_colors.BLACK)
                else:
...
class PassphraseTipsConfirm(FullSizeWindow):
    def __init__(
        ...
        callback_obj,
        icon_path="A:/res/warning.png",
        primary_color=lv_colors.CHARGERWALLET_GREEN,
    ):
        super().__init__(
            title,
            subtitle,
...
class UserGuide(Screen):
    def __init__(self, prev_scr=None):
        ...
        self.app_tutorial = ListItemBtn(
            self.container, _(i18n_keys.ITEM__CHARGERWALLET_APP_TUTORIAL)
        )
...
class HelpDetails(FullSizeWindow):
    def __init__(self):
        super().__init__(
            ...
            None,
            cancel_text=_(i18n_keys.BUTTON__CLOSE),
            icon_path="A:/res/chargerwallet-help.png",
        )
        self.container = ContainerFlexCol(self.content_area, self.icon, pos=(0, 24))
        self.item = DisplayItem(
            self.container,
        ...
        self.website.set_text("help.chargerwallet.com/hc")
