...
translations = [
    ...
    "ChargerWallet encrypted stores recovery phrase offline in security element, connecting and interacting with ChargerWallet app via bluetooth or USB.",
    ...
    "Are you sure to authenticate your device with the ChargerWallet secure server? Tap confirm to check whether your device is genuine and without tampered.",
    "Tap to Close",
    "Processing...",
    "Slide to Sign",
    "Slide to Reset",
    ...
    "Build ID",
    "Wallet",
    "Passphrase is enabled. Device will be required to enter passphrase every time when connect with ChargerWallet apps.",
    ...
    "Back Up with KeyTag",
    "Already have a ChargerWallet KeyTag? Tap the \"Backup\" button to convert the recovery phrase into a BIP39 dotmap.",
    "Backup",
    "Not Now",
    "Skip Backup",
    "KeyTag",
    ...
    "View Backside",
    "Connect to the ChargerWallet app, find the NFT owned by this hardware wallet, and tap the Collect button.",
    ...
    "Fingerprint",
    "Alternative way to PIN unlocking! Enable fingerprint identity sensor and makes it easy for you to get into ChargerWallet Pro.",
    "Add Fingerprint",
    "Get Started",
    ...
    "Back Up with Lite?",
    "Already have a ChargerWallet Lite? Tap the \"Backup\" to store your recovery phrase into your ChargerWallet Lite.",
    ...
    "Lite has been Reset",
    "The PIN has been entered incorrectly more than 10 times. ChargerWallet Lite has been self-erased to prevent brute force cracking of the backup data.",
    "I Got It",
    "Connect Failed",
    ...
    "Air Gap is a security measure that prevents the intermediate transmission media attacks.\nAfter enabling Air Gap, ChargerWallet Pro will disable all wired and wireless communication modules and maintain strict physical isolation from external devices or untrusted networks.",
    "OKX Wallet",
    "MetaMask",
    ...
    "SE Firmware",
    "Low battery (<10%). To keep the battery healthy, please ensure the device is fully charged before long-term storage.",
    ...
    "Turn on Bluetooth on both devices. Keep the wallet close to your phone, and click on the detected ChargerWallet Pro device name.",
    "Pair Devices",
    "Enter the pair code shown on your ChargerWallet Pro hardware wallet in the ChargerWallet App to pair your devices.",
    "Learn More",
    "Scan the QR code to view the detailed tutorial",
    "Access Wallet",
    "Open the OKX Mobile App, go to Wallet, select \"I already have one\" > \"Hardware wallet\" > \"ChargerWallet\".",
    ...
    "Choose \"TREZOR\", click \"Continue\", select \"Allow once for this session\", and follow the on-screen instructions to export. Input your ChargerWallet wallet PIN when prompted.",
    "Unlock Account",
    "From the list of accounts, select the one you wish to connect and click \"Unlock\".",
    "Open the OKX wallet extension, select \"Import Wallet\" > \"Hardware wallet\" > \"ChargerWallet\".",
    "Install ChargerWallet Bridge",
    "Download and install ChargerWallet Bridge if prompted, then refresh, choose your device, and enter your PIN.",
