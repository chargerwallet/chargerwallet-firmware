...
if TYPE_CHECKING:
    ...
    from trezor.enums import EthereumDataTypeChargerWallet  # noqa: F401
    ...
    class ChargerwalletGetFeatures(protobuf.MessageType):

        @classmethod
        def is_type_of(cls, msg: Any) -> TypeGuard["ChargerwalletGetFeatures"]:
            return isinstance(msg, cls)
    ...
    class ChargerwalletFeatures(protobuf.MessageType):
        chargerwallet_device_type: "ChargerWalletDeviceType | None"
        chargerwallet_board_version: "str | None"
        chargerwallet_boot_version: "str | None"
        chargerwallet_firmware_version: "str | None"
        ...
        chargerwallet_boot_hash: "bytes | None"
        chargerwallet_firmware_hash: "bytes | None"
        chargerwallet_board_build_id: "str | None"
        chargerwallet_boot_build_id: "str | None"
        chargerwallet_firmware_build_id: "str | None"
        chargerwallet_serial_no: "str | None"
        chargerwallet_ble_name: "str | None"
        ...
        def __init__(
            ...
            *,
            ...
            chargerwallet_boot_hash: "bytes | None" = None,
            chargerwallet_firmware_hash: "bytes | None" = None,
            chargerwallet_board_build_id: "str | None" = None,
            chargerwallet_boot_build_id: "str | None" = None,
            chargerwallet_firmware_build_id: "str | None" = None,
            chargerwallet_serial_no: "str | None" = None,
            chargerwallet_ble_name: "str | None" = None,
        ...
        @classmethod
        def is_type_of(cls, msg: Any) -> TypeGuard["ChargerwalletFeatures"]:
            return isinstance(msg, cls)
    ...
    class EthereumSignTypedDataChargerWallet(protobuf.MessageType):
        ...
        @classmethod
        def is_type_of(cls, msg: Any) -> TypeGuard["EthereumSignTypedDataChargerWallet"]:
            return isinstance(msg, cls)
    ...
    class EthereumTypedDataStructRequestChargerWallet(protobuf.MessageType):
        ...
        @classmethod
        def is_type_of(cls, msg: Any) -> TypeGuard["EthereumTypedDataStructRequestChargerWallet"]:
            return isinstance(msg, cls)

    class EthereumTypedDataStructAckChargerWallet(protobuf.MessageType):
        members: "list[EthereumStructMemberChargerWallet]"

        def __init__(
            self,
            *,
            members: "list[EthereumStructMemberChargerWallet] | None" = None,
        ) -> None:
            pass

        @classmethod
        def is_type_of(cls, msg: Any) -> TypeGuard["EthereumTypedDataStructAckChargerWallet"]:
            return isinstance(msg, cls)
    ...
    class EthereumTypedDataValueRequestChargerWallet(protobuf.MessageType):
        ...
        @classmethod
        def is_type_of(cls, msg: Any) -> TypeGuard["EthereumTypedDataValueRequestChargerWallet"]:
            return isinstance(msg, cls)
    ...
    class EthereumTypedDataValueAckChargerWallet(protobuf.MessageType):
        ...
        @classmethod
        def is_type_of(cls, msg: Any) -> TypeGuard["EthereumTypedDataValueAckChargerWallet"]:
            return isinstance(msg, cls)
    ...
    class EthereumStructMemberChargerWallet(protobuf.MessageType):
        ...
        @classmethod
        def is_type_of(cls, msg: Any) -> TypeGuard["EthereumStructMemberChargerWallet"]:
            return isinstance(msg, cls)

    class EthereumFieldTypeChargerWallet(protobuf.MessageType):
        data_type: "EthereumDataTypeChargerWallet"
        size: "int | None"
        entry_type: "EthereumFieldTypeChargerWallet | None"
        ...
        def __init__(
            ...
            *,
            data_type: "EthereumDataTypeChargerWallet",
            size: "int | None" = None,
            entry_type: "EthereumFieldTypeChargerWallet | None" = None,
            struct_name: "str | None" = None,
        ) -> None:
            pass

        @classmethod
        def is_type_of(cls, msg: Any) -> TypeGuard["EthereumFieldTypeChargerWallet"]:
            return isinstance(msg, cls)
    ...
    class EthereumGetPublicKeyChargerWallet(protobuf.MessageType):
        ...
        @classmethod
        def is_type_of(cls, msg: Any) -> TypeGuard["EthereumGetPublicKeyChargerWallet"]:
            return isinstance(msg, cls)
    ...
    class EthereumPublicKeyChargerWallet(protobuf.MessageType):
        ...
        @classmethod
        def is_type_of(cls, msg: Any) -> TypeGuard["EthereumPublicKeyChargerWallet"]:
            return isinstance(msg, cls)
    ...
    class EthereumGetAddressChargerWallet(protobuf.MessageType):
        ...
        @classmethod
        def is_type_of(cls, msg: Any) -> TypeGuard["EthereumGetAddressChargerWallet"]:
            return isinstance(msg, cls)
    ...
    class EthereumAddressChargerWallet(protobuf.MessageType):
        ...
        @classmethod
        def is_type_of(cls, msg: Any) -> TypeGuard["EthereumAddressChargerWallet"]:
            return isinstance(msg, cls)
    ...
    class EthereumSignTxChargerWallet(protobuf.MessageType):
        ...
        @classmethod
        def is_type_of(cls, msg: Any) -> TypeGuard["EthereumSignTxChargerWallet"]:
            return isinstance(msg, cls)
    ...
    class EthereumSignTxEIP1559ChargerWallet(protobuf.MessageType):
        ...
        data_length: "int"
        chain_id: "int"
        access_list: "list[EthereumAccessListChargerWallet]"
        ...
        def __init__(
            ...
            *,
            ...
            chain_id: "int",
            address_n: "list[int] | None" = None,
            access_list: "list[EthereumAccessListChargerWallet] | None" = None,
            to: "str | None" = None,
            data_initial_chunk: "bytes | None" = None,
        ) -> None:
            pass
        ...
        @classmethod
        def is_type_of(cls, msg: Any) -> TypeGuard["EthereumSignTxEIP1559ChargerWallet"]:
            return isinstance(msg, cls)
    ...
    class EthereumTxRequestChargerWallet(protobuf.MessageType):
        ...
        @classmethod
        def is_type_of(cls, msg: Any) -> TypeGuard["EthereumTxRequestChargerWallet"]:
            return isinstance(msg, cls)
    ...
    class EthereumTxAckChargerWallet(protobuf.MessageType):
        ...
        @classmethod
        def is_type_of(cls, msg: Any) -> TypeGuard["EthereumTxAckChargerWallet"]:
            return isinstance(msg, cls)
    ...
    class EthereumSignMessageChargerWallet(protobuf.MessageType):
        ...
        @classmethod
        def is_type_of(cls, msg: Any) -> TypeGuard["EthereumSignMessageChargerWallet"]:
            return isinstance(msg, cls)
    ...
    class EthereumMessageSignatureChargerWallet(protobuf.MessageType):
        ...
        @classmethod
        def is_type_of(cls, msg: Any) -> TypeGuard["EthereumMessageSignatureChargerWallet"]:
            return isinstance(msg, cls)
    ...
    class EthereumVerifyMessageChargerWallet(protobuf.MessageType):
        ...
        @classmethod
        def is_type_of(cls, msg: Any) -> TypeGuard["EthereumVerifyMessageChargerWallet"]:
            return isinstance(msg, cls)
    ...
    class EthereumSignTypedHashChargerWallet(protobuf.MessageType):
        ...
        @classmethod
        def is_type_of(cls, msg: Any) -> TypeGuard["EthereumSignTypedHashChargerWallet"]:
            return isinstance(msg, cls)
    ...
    class EthereumTypedDataSignatureChargerWallet(protobuf.MessageType):
        ...
        @classmethod
        def is_type_of(cls, msg: Any) -> TypeGuard["EthereumTypedDataSignatureChargerWallet"]:
            return isinstance(msg, cls)
    ...
    class EthereumAccessListChargerWallet(protobuf.MessageType):
        ...
        @classmethod
        def is_type_of(cls, msg: Any) -> TypeGuard["EthereumAccessListChargerWallet"]:
            return isinstance(msg, cls)
