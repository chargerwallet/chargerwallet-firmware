...
if not utils.BITCOIN_ONLY:
    ...
    trezor.enums.EthereumDataTypeChargerWallet
    import trezor.enums.EthereumDataTypeChargerWallet
    ...
    apps.ethereum.chargerwallet.get_address
    import apps.ethereum.chargerwallet.get_address
    apps.ethereum.chargerwallet.get_public_key
    import apps.ethereum.chargerwallet.get_public_key
    apps.ethereum.chargerwallet.keychain
    import apps.ethereum.chargerwallet.keychain
    apps.ethereum.chargerwallet.sign_message
    import apps.ethereum.chargerwallet.sign_message
    apps.ethereum.chargerwallet.sign_tx
    import apps.ethereum.chargerwallet.sign_tx
    apps.ethereum.chargerwallet.sign_tx_eip1559
    import apps.ethereum.chargerwallet.sign_tx_eip1559
    apps.ethereum.chargerwallet.sign_typed_data
    import apps.ethereum.chargerwallet.sign_typed_data
    apps.ethereum.chargerwallet.sign_typed_data_hash
    import apps.ethereum.chargerwallet.sign_typed_data_hash
    apps.ethereum.chargerwallet.verify_message
    import apps.ethereum.chargerwallet.verify_message
