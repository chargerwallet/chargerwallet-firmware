...
from trezor.messages import EthereumMessageSignatureChargerWallet as EthereumMessageSignature
...
if TYPE_CHECKING:
    from trezor.messages import EthereumSignMessageChargerWallet as EthereumSignMessage
