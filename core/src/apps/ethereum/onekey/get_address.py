...
from trezor.messages import EthereumAddressChargerWallet as EthereumAddress
...
if TYPE_CHECKING:
    from trezor.messages import EthereumGetAddressChargerWallet as EthereumGetAddress
