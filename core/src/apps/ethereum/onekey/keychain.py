...
if TYPE_CHECKING:
    ...
    from trezor.messages import (
        EthereumGetAddressChargerWallet as EthereumGetAddress,
        EthereumGetPublicKeyChargerWallet as EthereumGetPublicKey,
        EthereumSignMessageChargerWallet as EthereumSignMessage,
        EthereumSignTxChargerWallet as EthereumSignTx,
        EthereumSignTxEIP1559ChargerWallet as EthereumSignTxEIP1559,
        EthereumSignTypedDataChargerWallet as EthereumSignTypedData,
        EthereumSignTypedHashChargerWallet as EthereumSignTypedHash,
    )
