...
from trezor.messages import (
    EthereumAccessListChargerWallet as EthereumAccessList,
    EthereumTxRequestChargerWallet as EthereumTxRequest,
)
...
if TYPE_CHECKING:
    from trezor.messages import EthereumSignTxEIP1559ChargerWallet as EthereumSignTxEIP1559
