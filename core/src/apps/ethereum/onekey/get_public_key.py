...
from trezor.messages import EthereumPublicKeyChargerWallet as EthereumPublicKey, HDNodeType
...
if TYPE_CHECKING:
    from trezor.messages import EthereumGetPublicKeyChargerWallet as EthereumGetPublicKey
