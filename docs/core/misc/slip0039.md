# Use of SLIP-39 in chargerwallet-core
...
This does not quite match Chargerwallet's use of the "passphrase protection" feature, namely
...
## Seed handling in Chargerwallet

Chargerwallet stores a _mnemonic secret_ in a storage field `_MNEMONIC_SECRET`. This is the
...
Only the functions denoted in **bold** are implemented in chargerwallet-core. Recovery shares
