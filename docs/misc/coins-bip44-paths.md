...
Chargerwallet does not check if the path is followed by other non-hardened items (anyone can
...
6. <a name="Tezos"></a> Tezos supports multiple curves, but Chargerwallet currently supports
   ed25519 only.
